...
class DataProcessor:
    ...
    def process(self):
        ...
        base_columns = [
            ...
            'DXY', 'VIX', 'US_UNEMPLOYMENT', 'SP500_PE', 'HIGH_YIELD_SPREAD',
        ...
        new_df['US_MONETARY_BASE_GDP_RATIO'] = data['US_MONETARY_BASE'] / data[
            'US_GDP']
        ...
        base_columns = [
            ...
            'US_PPI', 'DXY', 'RRPONTSYD', 'WALCL', 'US_GDP', 'GDPC1', 'GS2',
        ...
        base_columns = [
            ...
            'HIGH_YIELD_SPREAD', 'US_UNEMPLOYMENT', 'SP500_PE'
        ]
